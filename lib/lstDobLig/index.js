...
export async function insertar_ultimo(){
    if(lista==null){
        let canvas = document.createElement("tutorial3");
        listaCanvas=new ListaDoblementeLigadaCanvas(canvas);
        lista=new ListaDoblementeLigada(listaCanvas);
    }
...
export async function eliminar_al_ultimo(){
    let canvas = document.getElementById("tutorial3");
    if(lista==null){
        listaCanvas= new ListaDoblementeLigadaCanvas(canvas);
        lista= new ListaDoblementeLigadaCanvas(listaCanvas);
    }
